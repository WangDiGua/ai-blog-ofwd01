...
export const Footer = () => {
  ...
  return (
    <footer className="mt-20">
      {/* Main Footer Content */}
      <div className="bg-white dark:bg-black border-t border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 md:mt-0 md:order-1">
                ...
                &copy; {new Date().getFullYear()} Sweet Potato. Design inspired by Apple. Powered by <span className="font-semibold text-gray-700 dark:text-gray-300">Google Gemini</span>.
                </p>
            </div>
            </div>
        </div>
