...
export const BlackHoleBackground = () => {
    ...
    useEffect(() => {
        ...
        // scene.fog = new THREE.FogExp2(0x020104, 0.025); // Optional fog

        const camera = new THREE.PerspectiveCamera(60, width / height, 0.1, 4000);
        // Fixed Camera Position (No OrbitControls)
        ...
        const starCount = 5000; // Reduced count for performance in embedded view
        ...
        const handleResize = () => {
            ...
            lensingPass.uniforms.aspectRatio.value = newWidth / newHeight;
        };
