...
import { ArrowRight, Circle, Clock, Hourglass } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto px-4 py-10 mb-20 overflow-hidden">
            ...
            <div className="relative">
                ...
                {articles.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-24 text-gray-400 bg-white/50 dark:bg-gray-800/20 backdrop-blur-sm rounded-2xl border border-dashed border-gray-200 dark:border-gray-700 relative z-10">
                        <Hourglass size={48} className="mb-4 opacity-50"/>
                        <p className="text-lg font-medium">时光长河静悄悄</p>
                        <p className="text-sm mt-2">暂无历史文章记录</p>
                    </div>
                )}
            </div>
